...
(function($) {
    $.fn.viewScroller = function(params) {
        ...
        var callFuncBeforeChange = function(viewName) {
            var stop = false;

            if (typeof params.beforeChange === 'function') {
                stop = params.beforeChange(viewName);
            }
        ...
        var callFuncAfterChange = function(n) {
            if (times > 0) {

                if (typeof params.afterChange === 'function') {
                    params.afterChange(n);
                }
